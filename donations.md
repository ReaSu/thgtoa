...
- Extend time for: 
	- Tor-Exit-01 node hosting (current expiration date is <span style="color: red">**September 30, 2021**</span>). About 60$/year needed total for this.
	- Tor-Exit-02 node hosting (current expiration date is **December 31, 2021**). About 60$/year needed total for this.
- Move VPS for the Tor .onion hosting (current expiration date is **April 1st, 2022**) to a cheaper hosting provider and extend for 2 more years. About 60$/year needed total for this.
